...
client.on("message", (channel, tags, message, self) => {
  ...
  if((tags.username ==="casebattle_official" ||tags.username ==="ggayci"||tags.username === "dim4k_top4k"||tags.username === "g1fl_" ||  tags.username ==="k0chet" ) && couponRegex.test(trimedMessage)){
    sockets.forEach(ws => ws.send(JSON.stringify({type:"coupon", text: trimedMessage})));
  }else if ((tags.username === "megarush51" || tags.username === "j05k1y" ||tags.username === "dim4k_top4k"|| tags.username === "g1fl_" ||tags.username === "k0chet" )  && promoRegex.test(trimedMessage)) {
